...
val emojiDatabaseModule = module {
    ...
    single<GetListEmojiUseCase> { GetListEmojiUseCaseImpl(get()) }
    single<GetRandomEmojiUseCase> { GetRandomEmojiUseCaseImpl(get()) }
    single<GitEmojiRepository> { GitEmojiRepositoryImpl(get(), get()) }
